...
class Comments_Input extends Input implements Plugins
{
	...
	public function add ($query) {
		$this->referer = parse_url(getenv('HTTP_REFERER'), PHP_URL_PATH);
		
		list($place, $item_id) = $this->parse_referer();
	...
	protected function parse_referer () {
		
		Globals::get_url($this->referer);
